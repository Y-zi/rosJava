...
public class Example {
    ...
    public static void main(String[] args) {        
        ROSBridgeClient client = new ROSBridgeClient("ws://10.7.5.88:9090");
...
//                Service<Empty, GetTime> timeService =
//                        new Service<Empty, GetTime>("/rosapi/get_time", Empty.class, GetTime.class, client);
//                timeService.callWithHandler(new Empty(), new MessageHandler<GetTime>() {
//                    @Override
//                    public void onMessage(GetTime message) {
//                        System.out.println(message.time.secs);
//                    }
//                });
            }
